# Terms of Service - PawPa Pet Care Assistant
...
Welcome to PawPa Pet Care Assistant. These Terms of Service ("Terms") govern your use of our mobile application, website, and related services (collectively, the "Service").

By downloading, installing, or using PawPa, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use our Service.

## 2. Description of Service

PawPa is a mobile application designed to help pet owners:
...
- You must be at least 13 years of age to use PawPa
...
When using PawPa, you agree not to:
...
Your use of PawPa is also governed by our Privacy Policy, which explains how we collect, use, and protect your information. By using our Service, you consent to the collection and use of information as described in our Privacy Policy.
...
PawPa and its original content, features, and functionality are owned by PawPa and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.

### 6.2 Trademarks

- "PawPa" and related logos are trademarks of PawPa
...
If you provide feedback or suggestions about PawPa, you grant us the right to use such feedback without obligation to compensate you.
...
- **Dependencies:** PawPa may rely on third-party services for functionality
...
- **Requirements:** PawPa requires compatible mobile devices and operating systems
...
- **Refunds:** Refunds are subject to the app store's refund policy
...
PawPa is provided on an "as is" and "as available" basis. We make no representations or warranties of any kind, express or implied, including but not limited to:
...
- **Not Medical Advice:** PawPa is not a substitute for professional veterinary care
...
To the maximum extent permitted by law, PawPa shall not be liable for:
...
You agree to indemnify, defend, and hold harmless PawPa and its officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, and expenses, including reasonable attorneys' fees, arising from or related to:
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and PawPa regarding the use of the Service.
...
**Email:** legal@pawpa.app  
**Website:** https://pawpa.app/terms  
...
By using PawPa Pet Care Assistant, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. You also acknowledge that you have read our Privacy Policy and agree to its terms.
...
Thank you for choosing PawPa as your pet care companion!
